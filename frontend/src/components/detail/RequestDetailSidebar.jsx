                  ...
                  <div key={sample.id} className="bg-white rounded-lg border border-slate-200 p-3 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className={`text-[9px] ${
                        sample.status === 'Dispatched' || sample.status === 'Delivered' ? 'bg-emerald-100 text-emerald-700' :
                        ...
                        {sample.status === 'Under Preparation' && (
                          <Button size="sm" className="h-6 text-[9px] bg-green-500 hover:bg-green-600 px-2"
                            onClick={() => {
                              ...
                              // Note: dispatchDialog is set in parent component
                              // This is handled via the parent's state setter
                            }}
                    ...
                    {canProcess && sample.status === 'Ready for Dispatch' && !sample.buyer_decision && (
